...
var appRoutes = [
    {
        path: "employer",
        component: employer_navbar_component_1.EmployerNavbarComponent,
        children: [
            {
                path: "",
                component: dashboard_component_1.EmployerDashboardComponent
            }
        ]
    }
];
var EmployerRoutingModule = /** @class */ (function () {
...
exports.EmployerRoutingModule = EmployerRoutingModule;
